  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">Manage categories for expenses and incomes.</p>
      </div>
            ...
            {categories.data?.map((c) => (
              <div key={c.id} className="flex items-center justify-between gap-4 py-3">
                <div className="min-w-0">
                  ...
                  {c.is_default ? <div className="text-xs text-slate-500 dark:text-slate-400">Default</div> : null}
                </div>
