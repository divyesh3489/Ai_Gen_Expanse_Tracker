...
import { createIncome, deleteIncome, listIncomes, updateIncome } from '../features/incomes/api'
    ...
    <div className="space-y-4">
      ...
      <Card className="p-4">
        {incomes.isLoading ? (
          ...
          <div className="text-sm text-rose-700 dark:text-rose-200">Failed to load incomes.</div>
        ) : (
