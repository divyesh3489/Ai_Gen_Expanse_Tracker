"""
Django settings for ExpanseTraker project.
...
ROOT_URLCONF = "ExpanseTraker.urls"
...
WSGI_APPLICATION = "ExpanseTraker.wsgi.application"
...
# Media files (user uploads / publicly served assets)
MEDIA_URL = "/media/"
